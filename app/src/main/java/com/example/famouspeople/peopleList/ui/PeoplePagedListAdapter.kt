...
class PeoplePagedListAdapter(
    ...
    PagedListAdapter<ViewPeopleResult, RecyclerView.ViewHolder>(PeopleDiffUtil()) {
    ...
    interface OnPeopleClickListener {
        fun onItemClick(item: ViewPeopleResult)
    }
    ...
    class PeopleViewHolder(
        ...
        fun bind(item: ViewPeopleResult) {
        ...
        fun bind(retryCallback: () -> Unit, networkState: NetworkState?) {
            itemView.apply {
                ...
                if (networkState?.errorMessageRes != null) {
                    binding.message.text = networkState.errorMessageRes
                }
...
class PeopleDiffUtil : DiffUtil.ItemCallback<ViewPeopleResult>() {
    override fun areItemsTheSame(oldItem: ViewPeopleResult, newItem: ViewPeopleResult): Boolean {
        return oldItem.id == newItem.id
    }

    override fun areContentsTheSame(
        oldItem: ViewPeopleResult, newItem: ViewPeopleResult
    ): Boolean {
